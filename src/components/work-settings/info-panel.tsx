...
export function InfoPanel() {
  return (
    <div className="space-y-8">
      <section className="overflow-hidden bg-card border-none shadow-sm rounded-2xl">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 text-xs font-bold uppercase tracking-widest bg-primary/10 text-primary p-4 rounded-xl border-none">
      ...
      <section className="bg-accent/30 shadow-sm border-none rounded-2xl p-8">
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            <div className="mt-1 w-8 h-8 rounded-lg bg-primary/10 flex-shrink-0 flex items-center justify-center border-none">
          ...
          <div className="flex gap-4">
            <div className="mt-1 w-8 h-8 rounded-lg bg-secondary/20 flex-shrink-0 flex items-center justify-center border-none">
