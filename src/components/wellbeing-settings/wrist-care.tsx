...
export function WristCare({ settings, toggleEnabled }: Props) {
  return (
    <section
    ...
    >
      <div>
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-4 relative z-10">
            ...
            <h3 className="text-xl font-bold text-foreground">Wrist Care</h3>
          </div>
      ...
      <div className="bg-background p-4 rounded-xl mt-auto">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Wrist care joins deep resets every{" "}
          {settings.breaks.wrist?.intervalMinutes ?? 270} minutes.
        </p>
      </div>
    </section>
  );
